...
class Function {
  ...
  example(isPrefix, command, args) {
    return `• ${this.texted("bold", "مثال")} : ${isPrefix + command} ${args}`;
  }
  ...
  ago(time) {
    ...
    if (seconds < 60) {
      return seconds === 1 ? 'منذ ثانية واحدة' : seconds + ' منذ ثانية واحدة';
    } else if (minutes < 60) {
      return minutes === 1 ? 'منذ دقيقة واحدة' : minutes + ' منذ دقيقة واحدة';
    } else if (hours < 24) {
      return hours === 1 ? 'منذ ساعة واحدة' : hours + ' منذ ساعة واحدة';
    } else if (days < 30) {
      return days === 1 ? 'منذ يوم واحدة' : days + ' منذ يوم واحدة';
    } else if (months < 12) {
      return months === 1 ? '1 منذ شهر واحدة' : months + ' منذ شهر واحدة';
    } else {
      return years === 1 ? ' 1 منذ سنة واحدة' : years + ' منذ سنة واحدة';
    }
  }
